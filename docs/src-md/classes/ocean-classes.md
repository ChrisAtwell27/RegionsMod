...
Six classes cover Ocean's core roles: defensive tank, crowd control, aquatic DPS, executioner, healer, and mobility.
...
- Portals cannot be placed inside any [Protected Area](../reference/protected-areas.md).
...
- If a regenerating **ore deposit** (see [Deposits](../gameplay/deposits.md)) would spawn blocks overlapping a portal, the portal is instantly destroyed.
